...
CIeDlg::CIeDlg(HINSTANCE hInstance, HWND hParentWnd, int nIconId)
...
LRESULT CIeDlg::OnGetMinMaxInfo(WPARAM wParam, LPARAM lParam)
{
	int nW = 250, nH = 470;
...
void CIeDlg::OnCreate()
{
	...
	if (m_pRightPic == NULL)
	{
		::MessageBox(m_hParent, _T("初始化 m_pRightPic 失败，程序无法启动！"), MSG_TITLE, MB_OK | MB_ICONSTOP);
		::PostMessage(m_hParent, WM_CLOSE, NULL, NULL);
		return;
	}
...
LRESULT CIeDlg::OnSize(HDWP hWinPoslnfo, WPARAM wParam, LPARAM lParam)
{
...
// 鼠标左键按下消息
void CIeDlg::DUI_OnLButtonDown(WPARAM wParam, LPARAM lParam)
{
...
// 鼠标左键抬起消息
void CIeDlg::DUI_OnLButtonUp(WPARAM wParam, LPARAM lParam)
{
...
// 鼠标左键双击消息
void CIeDlg::DUI_OnLButtonDblClk(WPARAM wParam, LPARAM lParam)
{
	__base_super::DUI_OnLButtonDblClk(wParam, lParam);
}

// 鼠标进入窗口
void CIeDlg::DUI_OnMouseHover(WPARAM wParam, LPARAM lParam)
{
...
// 鼠标离开窗口
void CIeDlg::DUI_OnMouseLeave(WPARAM wParam, LPARAM lParam)
{
...
void CIeDlg::OnPaint(HDC hPaintDc)
{
