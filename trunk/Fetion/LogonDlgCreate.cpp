...
CLogonDlgCreate::CLogonDlgCreate(HINSTANCE hInstance, HWND hParentWnd, int nIconId)
...
LRESULT CLogonDlgCreate::OnGetMinMaxInfo(WPARAM wParam, LPARAM lParam)
{
	int nW = 250, nH = 470;
...
LRESULT CLogonDlgCreate::OnSize(HDWP hWinPoslnfo, WPARAM wParam, LPARAM lParam)
{
...
// 鼠标左键按下消息
void CLogonDlgCreate::DUI_OnLButtonDown(WPARAM wParam, LPARAM lParam)
{
...
// 鼠标左键抬起消息
void CLogonDlgCreate::DUI_OnLButtonUp(WPARAM wParam, LPARAM lParam)
{
...
// 鼠标左键双击消息
void CLogonDlgCreate::DUI_OnLButtonDblClk(WPARAM wParam, LPARAM lParam)
{
	__base_super::DUI_OnLButtonDblClk(wParam, lParam);
}

// 鼠标进入窗口
void CLogonDlgCreate::DUI_OnMouseHover(WPARAM wParam, LPARAM lParam)
{
...
// 鼠标离开窗口
void CLogonDlgCreate::DUI_OnMouseLeave(WPARAM wParam, LPARAM lParam)
{
