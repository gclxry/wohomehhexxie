...
CRichEditDlg::CRichEditDlg(HINSTANCE hInstance, HWND hParentWnd, int nIconId)
...
CRichEditDlg::~CRichEditDlg(void)
{
}

LRESULT CRichEditDlg::OnGetMinMaxInfo(WPARAM wParam, LPARAM lParam)
{
	int nW = 250, nH = 470;
...
// 鼠标左键按下消息
void CRichEditDlg::DUI_OnLButtonDown(WPARAM wParam, LPARAM lParam)
{
...
// 鼠标左键抬起消息
void CRichEditDlg::DUI_OnLButtonUp(WPARAM wParam, LPARAM lParam)
{
...
// 鼠标左键双击消息
void CRichEditDlg::DUI_OnLButtonDblClk(WPARAM wParam, LPARAM lParam)
{
	__base_super::DUI_OnLButtonDblClk(wParam, lParam);
}

// 鼠标进入窗口
void CRichEditDlg::DUI_OnMouseHover(WPARAM wParam, LPARAM lParam)
{
...
// 鼠标离开窗口
void CRichEditDlg::DUI_OnMouseLeave(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CRichEditDlg::OnMoving(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CRichEditDlg::OnSizing(WPARAM wParam, LPARAM lParam)
{
...
LRESULT CRichEditDlg::OnTimer(WPARAM wParam, LPARAM lParam)
{
...
void CRichEditDlg::DrawGlassLine(HDC hMemoryDC, CRect DrawRect)
{
	Graphics DoGrap(hMemoryDC);
