...
class IPropertyControlInWindow;
...
// 子控件列表
typedef map<string, IPropertyControlInWindow*>			CHILD_CTRL_PROP_MAP;

class IPropertyControlInWindow : public IFeatureObject
{
public:
	IPropertyControlInWindow(void);
	virtual ~IPropertyControlInWindow(void);

	// 父控件属性
	void SetParentPropertyControl(IPropertyControlInWindow *pParent);
	virtual IPropertyControlInWindow* GetParentPropertyControl();
...
private:
	...
	IPropertyControlInWindow* m_pParentPropertyControl;
